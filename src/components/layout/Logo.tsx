...
export function Logo({
  ...
  return (
    <Link
      ...
      aria-label="PT International Information Technology"
    >
      ...
      <span className="flex flex-col leading-tight">
        <span className="text-base font-semibold sm:text-lg">IIT</span>
        <span className={cn('text-[10px] font-medium uppercase tracking-[0.18em]', variant === 'light' ? 'text-white/60' : 'text-slate-500')}>
